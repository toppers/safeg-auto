...
$
$     パス2のターゲット依存テンプレート（RH850U2A_GHS用）
$

$FUNCTION PRE_GENERATE_TSKSTK$
$NL$
#pragma ghs section sbss=".lbss"
$NL$
$END$

$FUNCTION POST_GENERATE_TSKSTK$
$NL$
#pragma ghs section sbss=default
$NL$
$END$

$FUNCTION PRE_GENERATE_OSTK$
$NL$
#pragma ghs section sbss=".lbss"
$NL$
$END$

$FUNCTION POST_GENERATE_OSTK$
$NL$
#pragma ghs section sbss=default
$NL$
$END$
...
$
$INCLUDE "../rh850u2a_gcc/target.tf"$
