...
/*
 *		ハードウェアカウンタのターゲット依存定義（RH850U2A-GCC用）
 */
...
#define HWC_DTIM_UNIT  0
#define HWC_DTIM_ID    0
#define HWC_CTIM_UNIT  0
#define HWC_CTIM_ID    1

#elif defined(HWC_USE_UNIT1)

#define HWC_DTIM_UNIT  1
#define HWC_DTIM_ID    0
#define HWC_CTIM_UNIT  1
#define HWC_CTIM_ID    1

#elif defined(HWC_USE_UNIT2)

#define HWC_DTIM_UNIT  2
#define HWC_DTIM_ID    0
#define HWC_CTIM_UNIT  2
#define HWC_CTIM_ID    1

#elif defined(HWC_USE_UNIT3)

#define HWC_DTIM_UNIT  3
#define HWC_DTIM_ID    0
#define HWC_CTIM_UNIT  3
#define HWC_CTIM_ID    1
 ...
 */
#if (HWC_DTIM_UNIT == 0)
#define HWC_DTIM_INTNO  (TAUJ0I0_INTNO + HWC_DTIM_ID)
#elif (HWC_DTIM_UNIT == 1)
#define HWC_DTIM_INTNO  (TAUJ1I0_INTNO + HWC_DTIM_ID)
#elif (HWC_DTIM_UNIT == 2)
#define HWC_DTIM_INTNO  (TAUJ2I0_INTNO + HWC_DTIM_ID)
#elif (HWC_DTIM_UNIT == 3)
#define HWC_DTIM_INTNO  (TAUJ3I0_INTNO + HWC_DTIM_ID)
 ...
 *  タイマクロック周波数（Hz）（80MHz）
 */
#define TIMER_CLOCK_HZ		((uint32) 80000000)

/*
 *  TAUJ関連レジスタ
 */
#define TAUJ_BASE(n)	((uint32)(((n == 0)||(n ==1))? (0xffbf7000U + (n * 0x200U)) : (0xffe80000U + ((n-2) * 0x1000U))))
 ...
 */
#define TAUJ_INTNO(n, ch)	(n == 0)? ((uint32) ((TAUJ0I0_INTNO + ch))) : ((uint32) (TAUJ1I0_INTNO + ch))
