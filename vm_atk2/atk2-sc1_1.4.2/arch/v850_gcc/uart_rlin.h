...
#define RLIN3x_BASE	RLIN36_BASE
#elif RLIN3_PORT_NO == 7
#define RLIN3x_BASE	RLIN37_BASE
#elif RLIN3_PORT_NO == 8
#define RLIN3x_BASE	RLIN38_BASE
#elif RLIN3_PORT_NO == 9
#define RLIN3x_BASE	RLIN39_BASE
#elif RLIN3_PORT_NO == 10
#define RLIN3x_BASE	RLIN310_BASE
#elif RLIN3_PORT_NO == 11
#define RLIN3x_BASE	RLIN311_BASE
#else
