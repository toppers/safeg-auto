...
startup_hook(void)
{
    ...
    if (coreid == 0) {
        ...
        sil_wrw_mem(PBG51_PBGPROT1_m(5), TBIT_HV_SPID|VM1_SPIDLIST);
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);
        
        /*
         *  TAUJ3I0へのアクセス権の設定
         */
        sil_wrw_mem(PBGERRSLV20_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG20_PBGPROT1_m(6), TBIT_HV_SPID|VM2_SPIDLIST);
         ...
         */
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG51_PBGPROT1_m(4), TBIT_HV_SPID|VM3_SPIDLIST);
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);
         ...
         */
        sil_wrw_mem(PBGERRSLV20_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG20_PBGPROT1_m(5), TBIT_HV_SPID|VM4_SPIDLIST);
        sil_wrw_mem(PBGERRSLV20_PBGKCPROT, LOCKKEY_VAL);

        /*
         *  TAUJ2/3のクロックをTAUJ0/1と同じCLK_HSBに変更
         */
        set_tauj23_clk(3);
        ...
        sil_wrw_mem(PBG32_PBGPROT1_m(1), (TBIT_HV_SPID|VM1_SPIDLIST));
         ...
         */
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG52_PBGPROT1_m(14), (TBIT_HV_SPID|VM1_SPIDLIST));
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);    
#endif /* RLIN3_PORT0 == 7 */
         ...
         */
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG52_PBGPROT1_m(11), (TBIT_HV_SPID|VM2_SPIDLIST));
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);
#endif /* RLIN3_PORT1 == 1 */
         ...
         */
        sil_wrw_mem(PBGERRSLV30_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG32_PBGPROT1_m(3), (TBIT_HV_SPID|VM2_SPIDLIST));
        sil_wrw_mem(PBGERRSLV30_PBGKCPROT, LOCKKEY_VAL);
#endif /* RLIN3_PORT1 == 1 */
         ...
         */
        sil_wrw_mem(PBGERRSLV30_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG32_PBGPROT1_m(2), TBIT_HV_SPID|VM3_SPIDLIST);
        sil_wrw_mem(PBGERRSLV30_PBGKCPROT, LOCKKEY_VAL);
#endif /* RLIN3_PORT2 == 2 */
         ...
         */
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG52_PBGPROT1_m(12), TBIT_HV_SPID|VM4_SPIDLIST);
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);
#endif /* RLIN3_PORT3 == 3 */
         ...
         */
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG53_PBGPROT1_m(0), TBIT_HV_SPID|VM4_SPIDLIST);
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);
#endif /* RLIN3_PORT3 == 11 */        
    }
