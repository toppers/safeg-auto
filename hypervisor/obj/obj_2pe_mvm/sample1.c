...
startup_hook(void)
{
    ...
    if (coreid == LEADER_COREID) {
        ...
        sil_wrw_mem(PBG32_PBGPROT1_m(1), (TBIT_HV_SPID|VM0_0_SPIDLIST|VM1_0_SPIDLIST));
         ...
         */
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG52_PBGPROT1_m(14), (TBIT_HV_SPID|VM0_0_SPIDLIST|VM1_0_SPIDLIST));
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);    
#endif /* RLIN3_PORT0 == 7 */
         ...
         */
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG52_PBGPROT1_m(11), (TBIT_HV_SPID|VM0_1_SPIDLIST|VM1_1_SPIDLIST));
        sil_wrw_mem(PBGERRSLV50_PBGKCPROT, LOCKKEY_VAL);
#endif /* RLIN3_PORT1 == 1 */
         ...
         */
        sil_wrw_mem(PBGERRSLV30_PBGKCPROT, UNLOCKKEY_VAL);
        sil_wrw_mem(PBG32_PBGPROT1_m(3), (TBIT_HV_SPID|VM0_1_SPIDLIST|VM1_1_SPIDLIST));
        sil_wrw_mem(PBGERRSLV30_PBGKCPROT, LOCKKEY_VAL);
#endif /* RLIN3_PORT1 == 1 */ 
    }
